...
class ResultsDetailScraper(ElTurfScraper):
    ...
    def save_results(self, data: Dict) -> str:
        """
        Saca la data de la carrera a un archivo JSON detallado.
        """
        try:
            target_dir = Path(self.base_path) / "resultados_detalle"
            target_dir.mkdir(parents=True, exist_ok=True)
            
            filename = f"resultados_detalle_{data['hipodromo']}_{data['fecha']}.json"
